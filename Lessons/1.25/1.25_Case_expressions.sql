...
SELECT
    job_title_short,
    salary_hour_avg::INT AS salary_hour,
    CASE
...
WITH salaries AS (
    SELECT
        ...
        END AS standardize_salary
    FROM job_postings_fact 
)

SELECT *,
    CASE
        WHEN standardize_salary IS NULL THEN 'Missing'
        WHEN standardize_salary < 75_000 THEN 'Low'
        WHEN standardize_salary < 150_000 THEN 'Medium'
        ELSE 'High'
